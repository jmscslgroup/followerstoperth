...
extern SimulinkPublisher<std_msgs::Float64, SL_Bus_followerstoperth_std_msgs_Float64> Pub_followerstoperth_251;
...
extern SimulinkParameterGetter<real64_T, double> ParamGet_followerstoperth_244;
